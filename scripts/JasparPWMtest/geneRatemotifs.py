...
def draw(kernels, savepath):
    ...
    for i in range(kernels.shape[0]):
        savepathtmp = savepath + "kernel_"+str(i)+".png"
        kernel = kernels[i]
        kernel = kernel
...
def main():
    ...
    """
    DataPath = "../../external/JasparSimu/HDF5/"
    resultpath = "../../result/JasparSimu/HDF5/"
    OutputPath = "../../result/JasparSimu/Motifs2/"
    mkdir(OutputPath)
    Datanamelist = [1,2,3,4]
    model_type = "MarkonvV"
