...
def run_model(KernelLen, KernelNum, RandomSeed, dataname, Modeltype):
	...
	DataName = "../../external/JasparSimu/HDF5/" + dataname + "/"
	...
	modelsave_output_filename = "../../result/JasparSimu/HDF5/"+dataname+"/"+Modeltype+"/model_KernelNum-" + str(
	...
	mkdir("../../result/JasparSimu/HDF5/"+dataname+"/"+Modeltype+"/")
