...
def Main():
	...
	outputpath = "../../result/simulation/picture/"
	mkdir(outputpath)
	...
	for dataname in datasetnamelist:
		...
		for Mtype in ModelType:
			...
			mkdir("../../result/simulation/files.2/")

			np.savetxt("../../result/simulation/files.2/"+str(dataname)+"_"+Mtype+"_auc.txt", np.asarray(auclist))
